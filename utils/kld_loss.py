...
from utils.loss import kld_loss,compute_kld_loss,KLDloss
...
class YOLOLoss(nn.Module):
    def __init__(self, anchors, num_classes, input_shape, anchors_mask=[[6, 7, 8], [3, 4, 5], [0, 1, 2]],
        ...
        self.kldbbox = kld_loss(taf=1.0, fun='sqrt')
    ...
    def __call__(self, predictions, targets, imgs):
        ...
        for i, prediction in enumerate(predictions):
            ...
            if n:
                ...
                # -------------------------------------------#
                tobj[b, a, gj, gi] = (1.0 - self.gr) + self.gr * (1 - kldloss).detach().clamp(0).type(
    ...
    def build_targets(self, predictions, targets, imgs):
        ...
        for batch_idx in range(predictions[0].shape[0]):
            ...
            # -------------------------------------------------------------#
            pair_wise_iou_loss = compute_kld_loss(txyxy, pxyxys, taf=1.0, fun='sqrt')   #compute_kld_loss(txyxy, pxyxys, taf=1.0, fun='sqrt')
