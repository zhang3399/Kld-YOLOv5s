...
if __name__ == '__main__':
    ...
    roxml_path = 'F:/A-zk/Rotating target/yolov5_obb-master/dataset/dataset_demo/xml'# 目录下保存的是需要转换的xml文件
    dotaxml_path = 'F:/A-zk/Rotating target/yolov5_obb-master/dataset/dataset_demo/1xml'
    out_path = 'F:/A-zk/Rotating target/yolov5_obb-master/dataset_demo/labelTxt/'
