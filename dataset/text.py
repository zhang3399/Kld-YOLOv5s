...
if __name__ == '__main__':
    ...
    roxml_path = 'F:/A-zk/yolov5_obb-master/dataset/xml'# 目录下保存的是需要转换的xml文件
    dotaxml_path = 'F:/A-zk/yolov5_obb-master/dataset/1xml'
    out_path = 'F:/A-zk/yolov5_obb-master/labelTxt/'
